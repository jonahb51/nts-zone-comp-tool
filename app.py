...
for zone in range(1, 6):
    ...
    df_line['Total Diff'] = (
        ...
        np.abs(df_line['Filler Speed (%)'] - filler_speed)
    ...
    results.append({
        ...
        "Match": f"{best['Temp (F)']}Â°F, {best['Humidity (%)']}% RH, {best['Filler Speed (%)']}% speed"
    })
